...
const commandFiles = readdirp(fileURLToPath(new URL("commands", import.meta.url)), {
	...
	directoryFilter: (dir) => dir.basename !== "sub",
});
...
try {
	...
	await i18next.use(Backend).init({
		...
		cleanCode: true,
		preload: ["en-US", "en-GB", "de", "es-ES", "ja", "ko", "pl", "zh-CH", "zh-TW","fr-FR"],
		supportedLngs: ["en-US", "en-GB", "de", "es-ES", "ja", "ko", "pl", "zh-CH", "zh-TW","fr-FR"],
		fallbackLng: ["en-US"],
		returnNull: false,
