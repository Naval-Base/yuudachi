	...
	cva({
		...
		variants: {
			variant: {
				...
				"secondary-filled": [
					"h-10 rounded-sm px-4 py-2.5",
					"bg-base-tangerine-500 text-base-neutral-900",
					"hover:bg-base-tangerine-300 dark:hover:bg-base-tangerine-700 dark:hover:text-base-neutral-200",
					"focus-visible:bg-base-tangerine-300 dark:focus-visible:bg-base-tangerine-700 dark:focus-visible:text-base-neutral-200",
					"pressed:bg-base-tangerine-200 dark:pressed:bg-base-tangerine-800 dark:pressed:text-base-neutral-100",
					"disabled:bg-base-neutral-200 disabled:text-base-neutral-900 dark:disabled:bg-base-neutral-700 dark:disabled:text-base-neutral-40",
				],
				"secondary-tonal": [
					"h-10 rounded-sm px-4 py-2.5",
					"bg-base-tangerine-300 text-base-neutral-900 dark:bg-base-tangerine-700 dark:text-base-neutral-40",
					"hover:bg-base-tangerine-500 dark:hover:text-base-neutral-900",
					"focus-visible:bg-base-tangerine-500 dark:focus-visible:text-base-neutral-900",
			...
			isDisabled: {
				true: "opacity-38 forced-colors:text-[GrayText] forced-colors:group-disabled:text-[GrayText] forced-colors:disabled:text-[GrayText]",
				false: null,
			},
			isPending: {
				true: "opacity-38",
