...
- [Code of Conduct](https://github.com/naval-base/yuudachi/blob/master/.github/CODE_OF_CONDUCT.md)
...
You will need [Node.js](http://nodejs.org) **version 14+**, [npm](https://www.npmjs.com/), [yarn2](https://yarnpkg.com/), and [Docker](https://www.docker.com/) installed.
...
This repository employs a [monorepo](https://en.wikipedia.org/wiki/Monorepo) setup which hosts a number of associated packages under the `packages` and `src` directory:
