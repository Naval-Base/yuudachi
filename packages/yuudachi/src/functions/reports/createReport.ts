...
export type CreateReport = Omit<Report, "channelId" | "contextMessagesIds" | "createdAt" | "reportId" | "status"> & {
	channelId?: Snowflake | null | undefined;
	contextMessagesIds?: Snowflake[] | null | undefined;
